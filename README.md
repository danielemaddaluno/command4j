...
## Using Command4j to grep local or remote files ##

You can use Command4j to obtain grep information across multiple local/remote files in an easy and fluent way:
```
